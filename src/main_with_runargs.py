...
if __name__ == "__main__":
    ...
    config["simulation_type"] = int(sys.argv[1])
    config["history_weight_personal"] = int(sys.argv[2])
    config["history_weight_reported"] = int(sys.argv[3])
    config["exploration_rate"] = float(sys.argv[4])
